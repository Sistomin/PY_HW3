...
#     3
#     -> 1
# n = int(input("Введите кол-во элиментов массива: "))
# Ai = [i+1 for i in range(n)]
# print(Ai)
# x = int(input("Введите число которое нужно найти в массиве: "))
# print(f"Число {x} встречается в массиве {Ai.count(x)} раз")
...
# Ai = [i+1 for i in range(n)]
# print(Ai)
# x = int(input("Введите число близкое к которому нужно найти в массиве: "))
# number = 0
# for i in range(len(Ai)):
#     if (x-Ai[i])<x-number and x-Ai[i]>0:
#         number=i
# print(f"В массиве есть элимент равный {Ai[number]}")
